...
{};
//可任意移动，涵盖所有指针算术能力（前三种支持operator++,第四种再加上operator--）
...
{
	typedef InputIteratorTag IteratorCategory;   // 迭代器类型
	typedef T                  ValueType;         // 迭代器所指对象的类型 
	typedef Distance           DifferenceType;    // 两个迭代器之间的距离
	typedef T*                 Pointer;           // 迭代器所指类型的指针
	typedef T&                 Reference;         // 迭代器所指类型的引用 
};
/////////////void
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//Advance的实现(令迭代器前进，此函数有两个参数，分别是迭代器i和数值n，主要作用是将i前进n距离，Forward Iterator和Input Iterator的实现是一样的)
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//为了提高效率，必须针对不同类型的iterator重载不同的处理函数
template <class InputIterator, class Distance>
